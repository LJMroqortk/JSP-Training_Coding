...
public class BoardDao {
	...
	*======================================================================*/
	...
	private Connection getConnection() throws Exception{
		...
		DataSource ds = (DataSource) envCtx.lookup("jdbc/ljmdb");//3. 자원들 중 원하는 jdbc/jskim 자원을 찾아내어 데이터소스를 가져옴
	...
	public void insert(BoardDto dto) {
		String sql = "INSERT INTO boards(SUBJECT, CONTENT, WRITER, REGDATE) VALUES(?, ?, ?, SYSDATE())";
	...
	public ArrayList<BoardDto> list(){
		String sql = "SELECT BCODE, SUBJECT, CONTENT, WRITER, REGDATE FROM boards order by bcode desc";
	...
	public BoardDto selectOne(int bcode) {
		...
		String sql = "SELECT subject, content, writer, regDate FROM boards WHERE bcode = ?";
	...
	public void update(BoardDto dto) {
		String sql = "UPDATE boards SET subject = ?, content = ?, writer = ?, regDate = ? WHERE bcode =?";
	...
	public void delete(int bcode) {
		String sql = "DELETE FROM boards WHERE bcode =?";
