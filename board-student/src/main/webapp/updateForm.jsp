...
<div class="container">
	...
	<br/>
	<form action="boardUpdatePro.bd" method="post">
		...
		<table class="table table-striped table-hover">
			...
			<tr>
				<td colspan="4">
					...
					<input type="button" value ="게시글 삭제" onclick ="location.href='boardDeletePro.bd?bcode=${dto.bcode}'">
					<input type="button" value ="게시글 목록" onclick ="location.href='boardListPro.bd'">
					<input type="button" value ="게시글 등록" onclick ="location.href='boardInsertPro.bd'">
				</td>
			</tr>
		</table><br><br>
	</form>
